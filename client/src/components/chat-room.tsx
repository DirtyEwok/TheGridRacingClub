      ...
      <div className="flex-1 overflow-hidden">
        <ScrollArea className="h-full">
          <div className="space-y-4 max-w-none p-4">
            ...
            <div className="max-h-[500px] sm:max-h-[600px] md:max-h-[750px] lg:max-h-[900px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-gray-800">
