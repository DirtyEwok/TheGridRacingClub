...
export class MemStorage implements IStorage {
  ...
  private initializeData() {
    ...
    const member2: Member = {
      id: randomUUID(),
      displayName: "Sarah Speed",
      gamertag: "SarahSpeed77",
    ...
    const member3: Member = {
      id: randomUUID(),
      displayName: "Mike Throttle",
      gamertag: "MikeThrottle",
    ...
    this.members.set(member4.id, member4);
    this.members.set(member5.id, member5);

    // Create sample registrations for upcoming races
    const registration1: Registration = {
      id: randomUUID(),
      raceId: race1.id,
      memberId: member1.id,
      registeredAt: new Date("2024-08-20T10:00:00Z"),
    };
    ...
    const registration2: Registration = {
      ...
      raceId: race1.id,
      memberId: member2.id,
      registeredAt: new Date("2024-08-20T14:30:00Z"),
    };
    ...
    const registration3: Registration = {
      ...
      raceId: race1.id,
      memberId: member3.id,
      registeredAt: new Date("2024-08-21T09:15:00Z"),
    };

    const registration4: Registration = {
      id: randomUUID(),
      raceId: race2.id,
      memberId: member1.id,
      registeredAt: new Date("2024-08-22T16:20:00Z"),
    };

    const registration5: Registration = {
      id: randomUUID(),
      raceId: race2.id,
      memberId: member4.id,
      registeredAt: new Date("2024-08-23T11:45:00Z"),
    };

    const registration6: Registration = {
      id: randomUUID(),
      raceId: race3.id,
      memberId: member2.id,
      registeredAt: new Date("2024-08-25T08:30:00Z"),
    };

    const registration7: Registration = {
      id: randomUUID(),
      raceId: race3.id,
      memberId: member5.id,
      registeredAt: new Date("2024-08-26T13:10:00Z"),
    };

    const registration8: Registration = {
      id: randomUUID(),
      raceId: race4.id,
      memberId: member3.id,
      registeredAt: new Date("2024-08-28T15:25:00Z"),
    };

    const registration9: Registration = {
      id: randomUUID(),
      raceId: race4.id,
      memberId: member4.id,
      registeredAt: new Date("2024-08-29T12:40:00Z"),
    };

    const registration10: Registration = {
      id: randomUUID(),
      raceId: race5.id,
      memberId: member1.id,
      registeredAt: new Date("2024-09-01T17:55:00Z"),
    };

    this.registrations.set(registration1.id, registration1);
    this.registrations.set(registration2.id, registration2);
    this.registrations.set(registration3.id, registration3);
    this.registrations.set(registration4.id, registration4);
    this.registrations.set(registration5.id, registration5);
    this.registrations.set(registration6.id, registration6);
    this.registrations.set(registration7.id, registration7);
    this.registrations.set(registration8.id, registration8);
    this.registrations.set(registration9.id, registration9);
    this.registrations.set(registration10.id, registration10);
  }
